...
public class DeleteTaskTest {
    ...
    public boolean deleteTask() {
        ...
        {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@aria-label='Delete task']//i[1]")));
        }
        driver.findElement(By.xpath("//button[@aria-label='Delete task']//i[1]")).click();
        {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Delete task']")));
        }
        driver.findElement(By.xpath("//span[text()='Delete task']")).click();
