...
public class RepeatTaskWeeklyTest {
    ...
    public boolean repeatTaskWeekly() {
        ...
        {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[text()='Repeat'])[2]")));
        }
        driver.findElement(By.xpath("(//span[text()='Repeat'])[2]")).click();
