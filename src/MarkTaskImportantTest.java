...
public class MarkTaskImportantTest {
    ...
    public boolean markTaskImportant() {
        ...
        {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class='importanceButton']//i[1]")));
        }
        driver.findElement(By.xpath("//span[@class='importanceButton']//i[1]")).click();
