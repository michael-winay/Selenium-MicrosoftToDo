...
public class SortTasksAlphabeticallyTest {
    ...
    public boolean sortTasksAlphabetically() {
        ...
        {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@aria-label='Sort']")));
        }
        driver.findElement(By.xpath("//button[@aria-label='Sort']")).click();
        {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Alphabetically']")));
        }
        driver.findElement(By.xpath("//span[text()='Alphabetically']")).click();
